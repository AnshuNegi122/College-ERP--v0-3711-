  ...
  return (
    <div className="p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-muted-foreground mb-6">Manage campus-wide announcements and notices</p>
          ...
          <div className="space-y-4">
            {announcements.map((announcement: any) => (
              <Card key={announcement._id} className="p-6">
                ...
                <Button variant="destructive" size="sm" onClick={() => handleDeleteAnnouncement(announcement._id)}>
                  Delete
                </Button>
              </Card>
            ))}
